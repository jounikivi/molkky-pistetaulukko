...
public class MolkkyPistelaskuriV2 {
    public static void main(String[] args) {
        ...
        try (Scanner lukija = new Scanner(System.in)) {
            ...
            while (true) {
                ...
                int pisteet = -1; // Alustetaan pisteet virheelliseksi
                while (pisteet < 0 || pisteet > 12) { // Toista, kunnes käyttäjä syöttää sallitut pisteet
                    System.out.print("Kuinka monta pistettä lisätään? (0-12): ");
